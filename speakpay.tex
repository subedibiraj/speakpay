...
\author{
    ...
    \small \href{https://github.com/YOUR_USERNAME/speakpay}{github.com/YOUR\_USERNAME/speakpay} \\
...
improves Devanagari numeral recognition accuracy from 0.0\% to 56.8\%
...
\textbf{Whisper large-v2 + LoRA (ours)} & \textbf{42.58} & \textbf{16.95} & \textbf{56.8} \\
\bottomrule
\end{tabular}
\end{table}
...
to standard ASR fine-tuning corpora. The results here should be read as a
...
performance. NumAcc of 56.8\% indicates substantial remaining error on
